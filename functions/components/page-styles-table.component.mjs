export const pageStyleTableComponent = async function (project, module, page, styles = [], otherStyles = []) {
    return `
        ...
        <div class="shadow">
            <table class="table table-hover">
              ...
              <tbody>
               ${getTableContents(project, module, page, styles)}
              </tbody>
            </table>
            ${await addInjectionModal(project, module, page, otherStyles)}
        </div>
    `
}

function getTableContents(project, module, page, styles = []) {
    let row = '';
        ...
        row += `<tr style="cursor: pointer">
                  ...
                  <td>
                    <div class="d-flex flex-row">
                        <form method="post" action="/project/${project}/modules/${module}/resources/pages/${page}/styles/${style}.style.scss/delete">
...
async function addInjectionModal(project, module, page, otherStyles) {
    function allOtherStyles() {
        let styles = ''
        for (const style of otherStyles) {
            styles += `
            <div style="margin-bottom: 5px">
                <form method="post" action="/project/${project}/modules/${module}/resources/pages/${page}/styles/${style}">
