 ...
 */
export const pageTemplateUpdateComponent = function (project, module, page, template, error = null) {
    return `
        <div style="margin-top: 24px" class="container col-xl-12 col-lg-12 col-sm-12 col-md-12 col-12">
            ...
            <div>
                <div>
                    ...
                    <div class="d-flex lex-row" style="margin-bottom: 8px">
                        <h3><a href="/project/${project}/modules/${module}/resources/pages/${page}" >${page} page</a> template</h3>
...
<!--                      <span class="visually-hidden">Loading...</span>-->
                ...
                <script>
                    document.getElementById('updateTemplateButton').onclick = ev => {
                        ...
                        fetch('/project/${project}/modules/${module}/resources/pages/${page}/template', {
                            method: 'POST',
                            headers: {
