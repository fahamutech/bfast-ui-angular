export const pageMethodsListComponent = function (project, module, page, methods = []) {
    return `
        <div class="d-flex flex-row" style="margin: 8px 0">
            <h3 style="margin: 0">Methods</h3>
            <span style="flex: 1 1 auto"></span>
            <a href="/project/${project}/modules/${module}/resources/pages/${page}/method">
         ...
         <div class="shadow">
            <table class="table table-hover">
              ...
              <tbody>
               ${getTableContents(project, module, page, methods)}
              </tbody>
            </table>
        </div>
    `
...
function getTableContents(project, module, page, methods = []) {
    let row = '';
        ...
        row += `<tr style="cursor: pointer">
                  ...
                  <td>
                    <div class="d-flex flex-row">
                        <a href="/project/${project}/modules/${module}/resources/pages/${page}/method/${method.name}">
                            <button class="btn-sm btn btn-primary">Update</button>
                        </a>
                        <div style="width: 10px; height: 10px"></div>
                        <form id="deleteMethod${methods.indexOf(method)}" method="post" action="/project/${project}/modules/${module}/resources/pages/${page}/method/${method.name}/delete">
