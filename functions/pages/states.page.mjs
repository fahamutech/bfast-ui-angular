...
export class StatesPage {
    ...
    async indexPage(project, module, error = null) {
        try {
            ...
            return appLayoutComponent(await stateListComponent(project, module, states, error), project);
        } catch (e) {
    ...
    async viewStatePage(project, module, stateName = null, error = null) {
        ...
        try {
            ...
            return appLayoutComponent(await stateCreateComponent(project, module, stateInJson, services, error), project);
        } catch (e) {
    ...
    async createMethodPage(project, module, state, method = {name: '', inputs: '', body: null}, error = null) {
        return appLayoutComponent(stateMethodCreateComponent(project, module, state, method, error));
    }
    ...
    async updateMethodPage(project, module, state, method, error = null) {
        ...
        return appLayoutComponent(stateMethodUpdateComponent(project, module, state, methodMap, error));
    }
}
